...
public class AjedrezServer {
    private static final int SERVER_PORT = 8830;

    private static final int HTTP_PORT = 8831;

    private static final int JMX_PORT = 8832;

    private static final int RMI_PORT = 8833;

    private static Logger log = LoggerFactory.getLogger(AjedrezServer.class);
    ...
    public static void main(String[] args) throws Throwable {
        ...
        AjedrezSessionHandler server = new AjedrezSessionHandler();
        ...
        ObjectName bean = new ObjectName(
                "AjedrezServer:type=AjedrezServiceManager");
